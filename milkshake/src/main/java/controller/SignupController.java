...
//            }
//
//            String response = ClientConnection.send("SIGNUP|" + username + "|" + password);
//
...
//
//                sceneChange.changeScene("Dashboard.fxml", signupBtn, newUser);
...
// VERSION - 2.0 - CRASHES SO I AM SCRATCHING THIS.
//package main.java.controller;
//
//import main.java.client.ClientConnection;
//import javafx.fxml.FXML;
...
//
//        try {
//            // one‑shot request to server for signup
//            String response = ClientConnection.send("SIGNUP|" + username + "|" + password);
//
...
//                Session.setUser(newUser);
//
//                // establish persistent socket for realtime chat
//                ClientConnection.getInstance().connect(HOST, PORT, username);
//
//                sceneChange.changeScene("Dashboard.fxml", signupBtn, newUser);
//            } else if (response.startsWith("ERROR")) {
//                String[] msg = response.split("\\|", 2);
//                errorLabel.setText(msg.length > 1 ? msg[1] : "Signup failed.");
//            } else {
//                errorLabel.setText("Unexpected server response.");
//            }
//        } catch (Exception ex) {
