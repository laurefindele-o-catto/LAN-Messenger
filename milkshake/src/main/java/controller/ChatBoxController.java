...
//    // Button for attaching images, may be null if not present in FXML (e.g., first version)
...
//        }
//        // Wire up image attachment button with debugging
//        if (imageButton != null) {
//            System.out.println("imageButton successfully injected from FXML");
//            imageButton.setOnAction(e -> sendImageAttachment());
//        } else {
//            System.out.println("Warning: imageButton is null; check FXML fx:id or controller setup");
//        }
//    }
//
...
//
//    /**
//     * Opens a FileChooser to select an image file, encodes it as base64, and sends it
//     * to the currently selected conversation. Images are embedded in the message
//     * text with a prefix of "IMG:<filename>:<base64>". If an error occurs, shows an alert.
//     */
...
//            if (idx > 0) {
//                String fileName = payload.substring(0, idx);
...
//            } else {
//                String body = payload;
//                String displayText = isGroup && !isSent ? m.getSender() + ": " + body : body;
