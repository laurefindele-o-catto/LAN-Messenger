...
////
////        switch (header) {
////            case "ACCEPTED_REQUEST_FROM":
////                if (parts.length >= 2) {
////                    String from = parts[1];
////                    for (FriendListener l : friendListeners) {
////                        dispatchPool.submit(() -> l.onFriendRequestAccepted(from));
////                    }
////                }
////                break;
////
////            case "DECLINED_REQUEST_FROM":
////                if (parts.length >= 2) {
////                    String from = parts[1];
////                    for (FriendListener l : friendListeners) {
////                        dispatchPool.submit(() -> l.onFriendRequestDeclined(from));
////                    }
////                }
////                break;
////
////            case "GOT_FRIEND_REQUEST_FROM":
////                if (parts.length >= 2) {
////                    String from = parts[1];
////                    for (FriendListener l : friendListeners) {
////                        dispatchPool.submit(() -> l.onFriendRequestReceived(from));
////                    }
////                }
////                break;
////
////            default:
////                // Unknown friend-related message
////                break;
////        }
////    }
//
...
//            String header = "UPLOAD_PROFILE_PHOTO|" + username + "|" + file.getName() + "|" + file.length() + "\n";
//            dos.writeBytes(header); // sends raw header with newline
//            dos.flush();
//
//            // Send file bytes
//            FileInputStream fis = new FileInputStream(file);
